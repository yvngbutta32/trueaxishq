...
export const bookings = mysqlTable("bookings", {
  ...
  depositStatus: mysqlEnum("depositStatus", ["required", "paid", "waived"]),
...
export const workflowWebhookDeliveries = mysqlTable("workflowWebhookDeliveries", {
  ...
  eventType: mysqlEnum("eventType", ["app.booking.created", "app.client.created", "app.invoice.paid", "app.proposal.signed", "job.status_changed", "service_visit.scheduled", "service_visit.status_changed"]).notNull(),
