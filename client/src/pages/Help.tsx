...
const categories = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: "Go to Dashboard → Settings → Booking Page. Choose a username (e.g., yourname), add a bio, and list the services you offer. Your booking page will be live at skillbridge.ai/book/yourname. Share this link with clients so they can self-book without back-and-forth emails.",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: "Share your booking page link (skillbridge.ai/book/yourname) with clients. They can select a service, choose a date and time, enter their name and email, and submit the booking. You'll receive a notification and the booking will appear in your Scheduling tab automatically.",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: "We offer a 14-day free trial so you can evaluate the platform before paying. After a payment has been processed, we do not offer refunds for partial billing periods. If you believe you were charged in error, contact billing@skillbridge.ai and we'll investigate promptly.",
      },
    ],
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-12">
        ...
        <section className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="mailto:support@skillbridge.ai"
          ...
          <p className="text-xs text-gray-600 mt-4">support@skillbridge.ai · Mon–Fri, 9am–6pm CT</p>
        </section>
      </div>
