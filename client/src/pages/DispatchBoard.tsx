...
const defaultRecurringPlanForm = () => ({
  ...
  weekday: "1", dayOfMonth: "1", startDate: new Date().toISOString().slice(0, 10), endDate: "", durationMinutes: "60", planningNote: "",
});
...
export default function DispatchBoard() {
  ...
  const submitRecurringPlan = () => {
    ...
    createRecurringPlan.mutate({
      ...
      startDate: recurringPlanForm.startDate, endDate: recurringPlanForm.endDate || null, durationMinutes,
