...
export default function FieldMode() {
  ...
  // Checklist toggles and client updates survive dead zones: they queue durably
  // and replay on reconnect. Timer and status writes stay online-only by design
  // because start/stop timestamps must stay billing-accurate.
  const { queueOperation, pendingCount, syncing } = useOfflineQueue(isOnline);
